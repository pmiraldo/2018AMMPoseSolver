...
squared_function_info::squared_function_info(const opengv::relative_pose::RelativeAdapterBase & adapter ){
...
squared_function_info::~squared_function_info(){}

Eigen::MatrixXd squared_function_info::get_M(){
  return M;
}

double squared_function_info::objective_function_value(const opengv::rotation_t & rotation, const opengv::translation_t & translation){
...
opengv::rotation_t squared_function_info::rotation_gradient(const opengv::rotation_t & rotation, const opengv::translation_t & translation){
  Eigen::MatrixXd v = Eigen::MatrixXd::Zero(18,1);
...
opengv::translation_t squared_function_info::translation_gradient(const opengv::rotation_t & rotation, const opengv::translation_t & translation){
  Eigen::MatrixXd v = Eigen::MatrixXd::Zero(18,1);
